...
class TravelMenu(MapScreen):
    ...
    def setup_locations(self):
        ...
        village_image = UiUtil.load_image_map(self.get_map_location_image_path("village.png"))
        ...
        forrest_image = UiUtil.load_image_map(self.get_map_location_image_path("forrest.png"))
